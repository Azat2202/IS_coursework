            ...
            <main className="flex-grow flex flex-col items-center justify-center mt-24 space-y-6 px-4">
                ...
                <div
                    ...
                    <div className="space-y-4 text-burgundy-300">
                        <p>
                            Можете ли вы себе представить, как это — пережить глобальную катастрофу? Думаю, что нет... Именно для этого был создан «Бункер Онлайн», чтобы вы смогли ощутить, как это. Наша игра очень проста, и на изучение правил вам не понадобится много времени! Уже после первой игры вы будете полностью понимать, как играть. Также перед началом игры советуем вам приготовить вкусный чай или кофе, взять печеньки и с головой погрузиться в игру!
                        </p>
                        <p>
                        ...
                        <p>
                            Бункер: Описание найденного бункера. Единственный шанс, чтобы выжить в случае катаклизма - это попасть в бункер. У вас есть информация о времени его постройки, местонахождении и данные о спальных комнатах.
                        </p>
                        <ul className="list-disc list-inside space-y-2">
                            ...
                            <li>Количество еды — запас продуктов, которых вам должно хватить на период пребывания в бункере.</li>
                        ...
                        <p>
                            Процесс игры: В первом игровом круге всё начинается с представления друг друга. Далее наступает время голосования, где игроки должны выбрать того, кто покинет временный лагерь и не попадёт в бункер.
                        </p>
                        <p>
